...
if not os.path.isfile("labelled" + filetag + ".out"): 
	...
	print("Using existing labelled" + filetag + ".out");
...
if not os.path.isfile("communities" + filetag + ".png"): 
	...
	os.system('python3 draw_communities.py {} {} {}'.format("communities" + filetag + ".out", "communities" + filetag + ".png", counties) + argtag);
else:
...
if not os.path.isfile("refinedcommunities" + filetag + ".png"): 
	...
	os.system('python3 draw_communities.py {} {} {}'.format("refinedcommunities" + filetag + ".out", "refinedcommunities" + filetag + ".png", counties) + argtag);
else:
...
if not os.path.isfile("editedcommunities" + filetag + ".out"): 
	...
	os.system('python3 edit_communities.py {} {} {}'.format("refinedcommunities" + filetag + ".out", "editedcommunities" + filetag + ".out", counties) + argtag);
else:
...
if not os.path.isfile("editedcommunities" + filetag + ".png"): 
	...
	os.system('python3 draw_communities.py {} {} {}'.format("editedcommunities" + filetag + ".out", "editedcommunities" + filetag + ".png", counties) + argtag);
else:
