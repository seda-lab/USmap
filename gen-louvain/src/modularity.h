...
inline void
Modularity::remove(int node, int comm, long double dnodecomm, long double dnodecomm_h) {
...
inline void
Modularity::insert(int node, int comm, long double dnodecomm, long double dnodecomm_h) {
  assert(node>=0 && node<size);
...
Modularity::gain(int node, int comm, long double dnc, long double degc) {
  ...
  //cerr << "comm " << comm << " dnc " << dnc << " tot " << tot[comm] << " degc " << degc << " " << m2 << endl; 
